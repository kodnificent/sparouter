  ...
  */
  ...
  _createClass(SPARouter, [{
    ...
    value: function get(uri, callback, thisArg) {
      if (!_utils["default"].isSet(uri)) throw new _utils.ArgumentNotFoundError("uri");
      if (!_utils["default"].isSet(callback)) throw new _utils.ArgumentNotFoundError("callback");
      if (!_utils["default"].isString(uri)) throw new _utils.ArgumentTypeError("uri", "string", uri);
      if (!_utils["default"].isFunction(callback)) throw new _utils.ArgumentTypeError("callback", "function", callback);
    ...
    value: function where(name, regExp) {
      //validate type
      if (!_utils["default"].isSet(name)) throw new _utils.ArgumentNotFoundError("name");
      if (!_utils["default"].isSet(regExp)) throw new _utils.ArgumentNotFoundError("regExp");
      if (!_utils["default"].isString(name)) throw new _utils.ArgumentTypeError("name", "string", name);
      if (!_utils["default"].isString(regExp)) throw new _utils.ArgumentTypeError("regExp", "string", regExp);
    ...
    value: function _goTo(url) {
      ...
      if (!_utils["default"].isSet(url)) throw new _utils.ArgumentNotFoundError("url");
      if (!_utils["default"].isString(url)) throw new _utils.ArgumentTypeError("url", "string", url);
      if (_utils["default"].isEmpty(url)) throw new TypeError("url cannot be empty");
    ...
    value: function _pathFor(name) {
      ...
      if (!_utils["default"].isSet(name)) throw new _utils.ArgumentNotFoundError("name");
      if (!_utils["default"].isString(name)) throw new _utils.ArgumentTypeError("name", "string", string);
      if (_utils["default"].isEmpty(name)) throw new TypeError("name cannot be empty");
      var nameFound = false;
      var uri;
      this.routes.some(function (route) {
        if (route.name === name) {
          ...
          if (_this2._containsParameter(uri)) {
            if (!_utils["default"].isSet(paramaters)) throw new _utils.ArgumentNotFoundError("parameters");
            if (!_utils["default"].isObject(parameters)) throw new _utils.ArgumentTypeError("parameters", "object", parameters);
            if (_utils["default"].isEmpty(parameters)) throw new TypeError("parameters cannot be empty");
            var array = [];
